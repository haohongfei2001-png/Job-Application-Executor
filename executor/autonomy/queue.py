...
class TaskQueue:
    ...
    def _resume_in_tx(self, db, tid, *, command_id=None, expected_revision=None):
        ...
        if row["blocker"] in {"browser_ownership_unknown", "user_paused_from_browser_ownership_unknown", "unknown_outcome", "user_paused_from_unknown_outcome", "auth_return_unverified", "account_identity_unverified", "draft_persistence_unverified"}:
