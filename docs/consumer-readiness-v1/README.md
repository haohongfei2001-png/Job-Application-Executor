> **Registration note — 2026-09-23:** This package is now registered in GitHub. The Pro audit text below is preserved as delivered and therefore still describes its pre-registration state. Canonical current registration state is in `STATUS.json`. JCR-01 is READY / NOT_STARTED and is not authorized by this registration.
...
<p><strong>状态：DESIGN_READY_FOR_REGISTRATION。实现未开始，尚未注册到 GitHub，尚未获得 consumer-ready 认证。</strong></p>
...
<tbody>
<tr>
<td><a href="#01_audit">01_AUDIT.md</a></td>
<td>真实产品模型、完整链路、系统性缺口、假完成、用户体验审计</td>
</tr>
<tr>
<td><a href="#02_architecture">02_ARCHITECTURE.md</a></td>
<td>拟冻结范围、架构决策、边界、数据与迁移设计</td>
</tr>
<tr>
<td><a href="#03_test_strategy">03_TEST_STRATEGY.md</a></td>
<td>16 层测试、独立判据、故障注入、隐私与 CI 分层</td>
</tr>
<tr>
<td><a href="#04_acceptance_matrix">04_ACCEPTANCE_MATRIX.md</a></td>
<td>最终验收逐项 PASS / FAIL；配套 JSON 可机读</td>
</tr>
<tr>
<td><a href="#05_rounds">05_ROUNDS.md</a></td>
<td>JCR-01～09 的目标、表面、实现、自动测试、门槛、停止条件、回退</td>
</tr>
<tr>
<td><a href="#06_execution_protocol">06_EXECUTION_PROTOCOL.md</a></td>
<td>注册与逐轮执行、唯一 writer、远端事实、完成和阻塞协议</td>
</tr>
<tr>
<td><a href="#07_final_certification">07_FINAL_CERTIFICATION.md</a></td>
<td>真实平台覆盖、1–3 次验收、最终证书、日常使用边界</td>
</tr>
<tr>
<td><a href="#08_evidence_index">08_EVIDENCE_INDEX.md</a></td>
<td>固定 SHA 源码、文档、CI、PR 和实验的证据索引与限制</td>
</tr>
<tr>
<td><a href="STATUS.json">STATUS.json</a></td>
<td>本包状态、轮次、授权与真人验收状态</td>
</tr>
<tr>
...
<p>当前任务只授权审计和计划交付。注册文件不等于授权实现，也不等于授权真实网站申请、发送验证码、安装登录项或购买服务。后续每次执行先读取当前远端 main、活跃 PR、STATUS 与本轮合同，不使用本包的旧 SHA 强行覆盖新工作。</p>
