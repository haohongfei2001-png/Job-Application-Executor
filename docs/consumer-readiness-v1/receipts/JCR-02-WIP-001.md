...
Implement durable task/tab/session lineage, lease/document/epoch guard, per-action observation and read-only UNKNOWN_OUTCOME reconciliation. Current second-run live block is a deliberate temporary safety fence; it must not become a certified recovery flow. Run browser kill/restart/draft oracle and human handoff tests, exact-head CI, review, merge and main readback. G-01–G-13 remain NOT_RUN / UNVERIFIED until their required evidence exists. DFG-001 remains JCR-04 fact-recovery work.
